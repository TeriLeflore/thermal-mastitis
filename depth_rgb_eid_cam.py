...
#created 3/4/24
# This is to test adding oak depth/disparity and rgb photos to OAK-D to see if works before adding to eid panel code
#it works!
#tested code on 3/5, the depth and disparity photos aren't showing even though it does capture the image . RGB is the only one that works.
